...
//   */
//  String insert(DataUser dataUser) {
//    String id;
//
...
//
//      id = getIdByCredentials(dataUser.username(), dataUser.password(), connection);
//    }
...
//  }
//
////  void delete(Long id) throws InvalidDataException {
...
//   */
//  private String getIdByCredentials(String username, String enc_password, Connection connection) throws SQLException {
...
//   */
//  private String getIdFromResultSet(ResultSet resultSet) throws SQLException {
//    String id = null;
//
//    //Get the dataUser.
//    if (resultSet.next()) {
